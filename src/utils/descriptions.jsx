export default function description(photoIndex) {
    switch (photoIndex) {
      case 1:
        return (
          <>
      ...
      case 2:
        return (
          <>
            <h1>Horseshoe Bend : La Courbe Majestueuse du Colorado</h1>
            <h3>Découvrez la splendeur naturelle de Horseshoe Bend, une œuvre d&apos;art
      ...
      case 3:
        return (
          <>
            <h1>Yosemite : La Symphonie Naturelle des Cascades et des Cimes Majestueuses</h1>
            <h3>Plongez dans la magnificence intemporelle de Yosemite, un paradis
               alpin où les montagnes majestueuses et les chutes d&apos;eau gracieuses
                se fondent dans une harmonie naturelle. Niché au cœur de la Sierra
                 Nevada en Californie, le parc national de Yosemite éblouit par
                  ses vallées profondes, ses forêts denses et ses sommets emblématiques.
                   L&apos;emblématique Half Dome et El Capitan s&apos;élèvent vers le ciel,
                    tandis que les chutes d&apos;eau emblématiques comme Yosemite Falls
      ...
      case 4:
        return (
          <>
            <h1>San Francisco : L&apos;Élégance Bohème de la Baie</h1>
            <h3>Découvrez la magie de San Francisco, une ville qui marie l&apos;élégance
                      ...
                      Que vous embarquiez à bord d&apos;un mythique tramway, traversiez
                       le pont emblématique ou vous relaxiez dans le célèbre parc
                        de Golden Gate, San Francisco offre une expérience inoubliable
                         alliant charme, diversité culturelle et une atmosphère cosmopolite unique.
              </h3>
            </>
          );
      case 5:
        return (
          <>
            <h1>Alcatraz : Entre Histoire Intrigante et Horizon Marin Imposant</h1>
            <h3>Explorez l&apos;énigmatique île d&apos;Alcatraz, symbole de l&apos;histoire fascinante
               de San Francisco. Nichée au cœur de la baie, cette ancienne prison fédérale
                est entourée d&apos;eaux tourbillonnantes et offre une vue imprenable sur le
                 panorama urbain de la ville. Plongez dans le passé captivant d&apos;Alcatraz,
              ...
              <br/>
                L&apos;île, autrefois impénétrable, dévoile aujourd&apos;hui ses mystères
                 à travers des visites guidées immersives. Découvrez les récits
                  poignants des détenus et ressentez l&apos;atmosphère unique de cet
                   endroit chargé d&apos;histoire. Que vous arpentiez les couloirs sombres
                    ou que vous contempliez la vue imprenable sur la baie depuis la cour,
                     Alcatraz vous offre une expérience inoubliable, mêlant tragédie,
                      courage et la beauté brute de son emplacement marin exceptionnel.
              </h3>
            </>
          );
      case 6:
        return (
          <>
            <h1>Golden Gate : L&apos;Élégance Emblématique enjambant la Baie de San Francisco</h1>
            <h3>Contemplez la majesté du Golden Gate, une icône architecturale qui transcende
               le temps au-dessus des eaux scintillantes de la baie de San Francisco.
                Avec ses tours emblématiques et sa couleur ocre éblouissante, ce pont
                 suspendu évoque l&apos;élégance structurelle et la beauté imposante.
            ...
            <br/>
                Explorez ses trottoirs accessibles aux piétons et ressentez la brise
                 ...
                 Que vous soyez témoin de l&apos;embrasement des tours au coucher du
                  soleil ou que vous vous aventuriez sous ses arches imposantes,
                   le Golden Gate offre une expérience inoubliable, symbolisant
                    l&apos;union entre l&apos;art, la fonctionnalité et la splendeur naturelle
                     dans la région emblématique de la baie de San Francisco.
              </h3>
            </>
          );
      default:
